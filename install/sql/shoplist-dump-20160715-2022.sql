...
119	11	choc, dark	t
121	11	choc, milk	t
120	11	choc, fruit n nut	t
129	11	digestive biscuits, dark choc	t
128	11	digestive biscuits, milk choc	t
...
SELECT pg_catalog.setval('items_seq', 262, true);
...
5	t	t	Sat 16th July 16	2016-07-14 22:39:07.861444+00
\.
...
SELECT pg_catalog.setval('shopping_lists_seq', 133, true);
